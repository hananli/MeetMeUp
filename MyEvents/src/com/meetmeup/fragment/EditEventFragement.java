...
public class EditEventFragement extends Fragment {
	...
	public void onStart() {
		if (DashBoard.actionBar != null) {
			DashBoard.resetActionBarTitle("Edit Event");
	...
	void setDataTOView(){
		...
		MinparticipantsEt.setText(dataBean.getMax_participants());
		MaxparticipantsEt.setText(dataBean.getMin_participants());
		String eventType = dataBean.getEvent_type();
